<div class="row">
    <div class="col-lg-12">
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label"><?php echo e(cleanLang(__('lang.mobile_no'))); ?></label>
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="mobile_no" name="mobile_no" placeholder=""
                    value="<?php echo e($lead->mobile_no ?? ''); ?>">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                <select class="select2-basic form-control form-control-sm" id="branch_id" name="branch_id">
                    ...
                    <option value="<?php echo e($br->branch_id); ?>" <?php if(isset($lead->branch_id) && ($lead->branch_id == $br->branch_id)): ?> selected <?php endif; ?>>
        ...
        <div class="form-group row">
            ...
            <div class="col-12 col-lg-9">
                <select class="form-control form-control-sm"  id="is_active" name="is_active">
                    ...
                    <option value="1" <?php if(isset($lead->is_active) && $lead->is_active==1): ?> selected <?php endif; ?>>Active</option>
                    <option value="0" <?php if(isset($lead->is_active) && $lead->is_active==0): ?> selected <?php endif; ?>>In Active</option>
                </select>
...
</div><?php /**PATH D:\xamppNew\htdocs\crm\application\resources\views/pages/leads/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>