<div class="row" id="js-trigger-invoices-modal-add-edit" data-payload="<?php echo e($page['section'] ?? ''); ?>">
    <div class="col-lg-12">
		...
		<div class="form-group row">
				<label
					class="col-sm-12 col-lg-3 text-left control-label col-form-label required"><?php echo e(cleanLang(__('lang.sale'))); ?>*</label>
				<div class="col-sm-12 col-lg-9">
					
					<select class="form-control form-control-sm"  id="sale_id" name="sale_id">
						<option value="">Select Sale</option>
						<?php $__currentLoopData = $sales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<option value="<?php echo e($sale->sale_id); ?>" <?php if(isset($invoice) && $invoice->sale_id==$sale->sale_id): ?> selected <?php endif; ?> ><?php echo e($sale->sale_id); ?></option>
						<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					</select>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-12 col-lg-9">
					<select class="form-control form-control-sm"  id="is_active" name="is_active">
						...
						<option value="1" <?php if(isset($invoice) && $invoice->is_active==1): ?> selected <?php endif; ?>>Active</option>
						<option value="0" <?php if(isset($invoice) && $invoice->is_active==0): ?> selected <?php endif; ?>>Inactive</option>
					</select>
				</div>
			</div>
			<!--/#[edit] city-->
...
</div><?php /**PATH D:\xamppNew\htdocs\crm\application\resources\views/pages/invoices/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>