        ...
        <div class="form-group row">
            ...
            <div class="col-12">
                <select class="form-control form-control-sm"  id="is_active" name="is_active">
                    ...
                    <option value="1" <?php if(isset($role->is_active) && $role->is_active==1): ?> selected <?php endif; ?>>Active</option>
                    <option value="0" <?php if(isset($role->is_active) && $role->is_active==0): ?> selected <?php endif; ?>>In Active</option>
                </select>
...
</div><?php /**PATH D:\xamppNew\htdocs\crm\application\resources\views/pages/settings/sections/roles/modals/add-edit-inc.blade.php ENDPATH**/ ?>