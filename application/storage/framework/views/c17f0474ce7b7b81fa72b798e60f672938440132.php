<head>
    ...
    <script src="crm/public/vendor/js/vendor.header.js?v=<?php echo e(config('system.versioning')); ?>"></script>
    ...
    <!--VENDORS CSS-->
    <link rel="stylesheet" href="crm/public/vendor/css/vendor.css?v=<?php echo e(config('system.versioning')); ?>">

    <!--ICONS-->
    <link rel="stylesheet" href="crm/public/vendor/fonts/growcrm-icons/styles.css?v=<?php echo e(config('system.versioning')); ?>">
    ...
    <link href="crm/public/themes/default/css/style.css?v=<?php echo e(config('system.settings_system_javascript_versioning')); ?>"
        rel="stylesheet">
    <?php else: ?>
    <?php if(auth()->check()): ?>
    <link
        href="crm/public/themes/<?php echo e(auth()->user()->pref_theme); ?>/css/style.css?v=<?php echo e(config('system.settings_system_javascript_versioning')); ?>"
        rel="stylesheet">
    <?php else: ?>
    ...
    <link href="crm/public/css/custom.css?v=<?php echo e(config('system.versioning')); ?>" rel="stylesheet">

    <!--PRINTING CSS-->
    <link href="crm/public/css/print.css?v=<?php echo e(config('system.versioning')); ?>" rel="stylesheet">
    ...
    <!--boot js-->
    <script src="crm/public/js/core/head.js?v=<?php echo e(config('system.versioning')); ?>"></script>
...
</head><?php /**PATH D:\xamppNew\htdocs\crm\application\resources\views/layout/header.blade.php ENDPATH**/ ?>