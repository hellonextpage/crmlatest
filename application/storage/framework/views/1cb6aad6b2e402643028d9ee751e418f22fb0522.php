...
<aside class="left-sidebar" id="js-trigger-nav-team">
            ...
            <ul id="sidebarnav"  data-modular-id="main_menu_team">
                ...
                <li data-modular-id="main_menu_team_projects" class="sidenav-menu-item <?php echo e($page['mainmenu_projects'] ?? ''); ?>">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <?php endif; ?>
                        <li class="sidenav-submenu <?php echo e($page['submenu_inventory'] ?? ''); ?>"
                            id="submenu_project_inventory">
                            <a href="<?php echo e(_url('/inventory')); ?>"
                                class="<?php echo e($page['submenu_inventory'] ?? ''); ?>"><?php echo e(cleanLang(__('lang.inventory'))); ?></a>
                        </li>
                ...
                <li data-modular-id="main_menu_team_tasks" class="sidenav-menu-item <?php echo e($page['mainmenu_tasks'] ?? ''); ?> menu-tooltip menu-with-tooltip"
                ...
                <li data-modular-id="main_menu_team_leads" class="sidenav-menu-item <?php echo e($page['mainmenu_leads'] ?? ''); ?> menu-tooltip menu-with-tooltip"
                ...
                <li data-modular-id="main_menu_team_billing" class="sidenav-menu-item <?php echo e($page['mainmenu_sales'] ?? ''); ?>">
                    <a class="has-arrow waves-effect waves-dark" href="javascript:void(0);" aria-expanded="false">
                        <i class="ti-wallet"></i>
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li class="sidenav-submenu <?php echo e($page['submenu_proposals'] ?? ''); ?>" id="submenu_proposals">
                            <a href="<?php echo e(URL('proposals')); ?>"
                ...
                <li data-modular-id="main_menu_team_subscriptions" class="sidenav-menu-item <?php echo e($page['mainmenu_subscription'] ?? ''); ?> menu-tooltip menu-with-tooltip"
                ...
                <li data-modular-id="main_menu_team_knowledgebase" class="sidenav-menu-item <?php echo e($page['mainmenu_kb'] ?? ''); ?> menu-tooltip menu-with-tooltip"
                ...
                <li data-modular-id="main_menu_team_team" class="sidenav-menu-item <?php echo e($page['mainmenu_settings'] ?? ''); ?>">
                    <a class="has-arrow waves-effect waves-dark" href="javascript:void(0);" aria-expanded="false">
                        <i class="ti-panel"></i>
                ...
                <li data-modular-id="main_menu_team_other" class="sidenav-menu-item <?php echo e($page['mainmenu_settings'] ?? ''); ?>">
                    <a class="has-arrow waves-effect waves-dark" href="javascript:void(0);" aria-expanded="false">
                        <i class="ti-panel"></i>
                        <span class="hide-menu"><?php echo e(cleanLang(__('lang.other'))); ?>
    ...
    <!-- End Sidebar scroll-->
</aside><?php /**PATH D:\xamppNew\htdocs\crm\application\resources\views/nav/leftmenu-team.blade.php ENDPATH**/ ?>