<div class="card" id="team-table-wrapper" id="team-table-wrapper">
    <div class="card-body">
        <div class="table-responsive list-table-wrapper">
            <?php if(!$appointmentmode->isEmpty()): ?>
            <table id="team-list-table" class="table m-t-0 m-b-0 table-hover no-wrap contact-list" data-page-size="10">
                ...
                <tbody id="appointmentmode-view-wrapper">
                    <!--ajax content here-->
                    <?php echo $__env->make('pages.appointmentmode.components.table.ajax', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <!--ajax content here-->
                </tbody>
                <tfoot>
                    <tr>
...
</div><?php /**PATH D:\xamppNew\htdocs\crm\application\resources\views/pages/appointmentmode/components/table/table.blade.php ENDPATH**/ ?>