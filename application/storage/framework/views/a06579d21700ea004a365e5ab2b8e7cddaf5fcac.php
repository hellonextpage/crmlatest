<div class="row">
    <div class="col-lg-12">
		...
		<div class="form-group row">
				<label
					class="col-sm-12 col-lg-3 text-left control-label col-form-label"><?php echo e(cleanLang(__('lang.attachment'))); ?></label>
				<div class="col-sm-12 col-lg-9">
...
</div><?php /**PATH D:\xamppNew\htdocs\crm\application\resources\views/pages/payments/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>