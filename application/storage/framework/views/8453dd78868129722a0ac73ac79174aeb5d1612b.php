    ...
    <td class="projects_col_action actions_column">
        ...
        <span class="list-table-action dropdown font-size-inherit">
            ...
            <button type="button" title="<?php echo e(cleanLang(__('lang.assigned_users'))); ?>"
                ...
                data-action-url="<?php echo e(urlResource('/projects/'.$project->project_id.'/assigned')); ?>" data-action-method="PUT"
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<!--each row--><?php /**PATH D:\xamppNew\htdocs\crm\application\resources\views/pages/projects/views/list/table/ajax.blade.php ENDPATH**/ ?>