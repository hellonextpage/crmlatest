<div class="row" id="js-projects-modal-add-edit" data-section="<?php echo e($page['section']); ?>"
    ...
    <div class="col-lg-12">
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label"><?php echo e(cleanLang(__('lang.branch'))); ?></label>
            <div class="col-sm-12 col-lg-9">
                <select class="select2-basic form-control form-control-sm" id="branch_id" name="branch_id">
                    ...
                    <option value="<?php echo e($br->branch_id); ?>" <?php if(isset($project->branch_id) && ($project->branch_id == $br->branch_id)): ?> selected <?php endif; ?>>
                        <?php echo e($br->branch_name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
        </div>
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label"><?php echo e(cleanLang(__('lang.address'))); ?></label>
            <div class="col-sm-12 col-lg-9">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="city_id" name="city_id"
                    value="<?php echo e($project->city_id ?? ''); ?>">
            </div>
        </div>
        <!--/#[edit] city-->
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label"><?php echo e(cleanLang(__('lang.area'))); ?></label>
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="area" name="area"
                    value="<?php echo e($project->area ?? ''); ?>">
            </div>
        </div>
        <!--/#[edit] area-->
        <!--[edit] pincode-->
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label"><?php echo e(cleanLang(__('lang.pincode'))); ?></label>
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="pincode" name="pincode"
                    value="<?php echo e($project->pincode ?? ''); ?>">
            </div>
        </div>
        <!--/#[edit] pincode-->
        <!--[edit] map_location-->
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label"><?php echo e(cleanLang(__('lang.map'))); ?></label>
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="map_location" name="map_location"
                    value="<?php echo e($project->map_location ?? ''); ?>">
            </div>
        </div>
        <!--/#[edit] map_location-->
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label"><?php echo e(cleanLang(__('lang.net'))); ?></label>
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="net_layout_area" name="net_layout_area"
                    value="<?php echo e($project->net_layout_area ?? ''); ?>">
            </div>
        </div>
        <!--/#[edit] net_layout_area-->
        <!--[edit] plot_area-->
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label"><?php echo e(cleanLang(__('lang.plot'))); ?></label>
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="plot_area" name="plot_area"
                    value="<?php echo e($project->plot_area ?? ''); ?>">
            </div>
        </div>
        <!--/#[edit] plot_area-->
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label"><?php echo e(cleanLang(__('lang.site_rsrvd_for_public'))); ?></label>
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="site_rsrvd_for_public" name="site_rsrvd_for_public"
                    value="<?php echo e($project->site_rsrvd_for_public ?? ''); ?>">
            </div>
        </div>
        <!--/#[edit] site_rsrvd_for_public-->
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label"><?php echo e(cleanLang(__('lang.roads_area'))); ?></label>
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="roads_area" name="roads_area"
                    value="<?php echo e($project->roads_area ?? ''); ?>">
            </div>
        </div>
        <!--/#[edit] roads_area-->
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label"><?php echo e(cleanLang(__('lang.approval_no'))); ?></label>
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="approval_no" name="approval_no"
                    value="<?php echo e($project->approval_no ?? ''); ?>">
            </div>
        </div>
        <!--/#[edit] approval_no-->
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label"><?php echo e(cleanLang(__('lang.ref_lr_no'))); ?></label>
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="ref_lr_no" name="ref_lr_no"
                    value="<?php echo e($project->ref_lr_no ?? ''); ?>">
            </div>
        </div>
        <!--/#[edit] ref_lr_no-->
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label"><?php echo e(cleanLang(__('lang.apporval_dt'))); ?></label>
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="apporval_dt" name="apporval_dt"
                    value="<?php echo e($project->apporval_dt ?? ''); ?>">
            </div>
        </div>
        <!--/#[edit] apporval_dt-->
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label"><?php echo e(cleanLang(__('lang.authority_blongs_to'))); ?></label>
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="authority_blongs_to" name="authority_blongs_to"
                    value="<?php echo e($project->authority_blongs_to ?? ''); ?>">
            </div>
        </div>
        <!--/#[edit] authority_blongs_to-->
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label"><?php echo e(cleanLang(__('lang.permission_no'))); ?></label>
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="permission_no" name="permission_no"
                    value="<?php echo e($project->permission_no ?? ''); ?>">
            </div>
        </div>
        <!--/#[edit] permission_no-->
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label"><?php echo e(cleanLang(__('lang.measurements'))); ?></label>
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="measurements" name="measurements"
                    value="<?php echo e($project->measurements ?? ''); ?>">
            </div>
        </div>
        <!--/#[edit] measurements-->
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label"><?php echo e(cleanLang(__('lang.partnered_banks'))); ?></label>
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="partnered_banks" name="partnered_banks"
                    value="<?php echo e($project->partnered_banks ?? ''); ?>">
            </div>
        </div>
        <!--/#[edit] partnered_banks-->
        ...
        <?php endif; ?>
    </div><?php /**PATH D:\xamppNew\htdocs\crm\application\resources\views/pages/projects/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>