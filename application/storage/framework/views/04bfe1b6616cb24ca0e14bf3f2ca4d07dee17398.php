        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                <select class="select2-basic form-control form-control-sm" id="branch_id" name="branch_id">
                    ...
                    <option value="<?php echo e($br->branch_id); ?>" <?php if(isset($user->branch_id) && ($user->branch_id == $br->branch_id)): ?> selected <?php endif; ?>>
...
</div><?php /**PATH D:\xamppNew\htdocs\crm\application\resources\views/pages/team/modals/add-edit-inc.blade.php ENDPATH**/ ?>