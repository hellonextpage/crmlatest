<div class="count-<?php echo e(@count($inventory)); ?>" id="projects-view-wrapper">
    <div class="card">
        <div class="card-body">
            <div class="table-responsive list-table-wrapper">
                ...
                <?php endif; ?> <?php if(@count($inventory) == 0): ?>
                <!--nothing found-->
...
</div><?php /**PATH D:\xamppNew\htdocs\crm\application\resources\views/pages/inventory/views/list/table/table.blade.php ENDPATH**/ ?>