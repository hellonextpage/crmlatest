...
<div class="col-md-12  col-lg-6 align-self-center text-right parent-page-actions p-b-9"
    ...
    <div id="list-page-actions">
        ...
        <button type="button" title="<?php echo e(cleanLang(__('lang.assigned_users'))); ?>"
            ...
            data-action-url="<?php echo e(urlResource('/projects/'.$project->project_id.'/assigned?ref=page')); ?>" data-action-method="PUT"
...
<!-- action buttons --><?php /**PATH D:\xamppNew\htdocs\crm\application\resources\views/pages/project/components/misc/actions.blade.php ENDPATH**/ ?>