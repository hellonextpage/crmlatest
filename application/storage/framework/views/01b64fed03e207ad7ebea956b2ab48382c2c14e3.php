...
<div class="card" id="project_details" data-progress="<?php echo e($project->project_progress); ?>">
    ...
    <div class="card-body p-t-0 p-b-0">
        ...
        <div class="x-each-field m-b-18">
            ...
            <div class="x-content"><?php echo customFieldValue($field->customfields_name, $project, $field->customfields_datatype); ?></div>
        </div>
        <?php endif; ?>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<!-- Column --><?php /**PATH D:\xamppNew\htdocs\crm\application\resources\views/pages/project/components/misc/details.blade.php ENDPATH**/ ?>