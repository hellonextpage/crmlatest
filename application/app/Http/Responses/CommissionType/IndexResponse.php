...
namespace App\Http\Responses\CommissionType;
...
class IndexResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            case 'load':
                $template = 'pages/commissiontype/components/table/ajax';
            ...
            case 'search':
                $template = 'pages/commissiontype/components/table/table';
            ...
            default:
                $template = 'pages/commissiontype/tabswrapper';
            ...
            $html = view($template, compact('commission'))->render();
            ...
            return view('pages/commissiontype/wrapper', compact('page','commission'))->render();
        }
