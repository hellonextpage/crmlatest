...
namespace App\Http\Responses\AppointmentType;
...
class IndexResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            case 'load':
                $template = 'pages/appointmenttype/components/table/ajax';
            ...
            case 'search':
                $template = 'pages/appointmenttype/components/table/table';
            ...
            default:
                $template = 'pages/appointmenttype/tabswrapper';
            ...
            $html = view($template, compact('appointmenttype'))->render();
            ...
            return view('pages/appointmenttype/wrapper', compact('page','appointmenttype'))->render();
        }
