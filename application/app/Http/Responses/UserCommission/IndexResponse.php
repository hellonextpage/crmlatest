...
namespace App\Http\Responses\UserCommission;
...
class IndexResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            case 'load':
                $template = 'pages/usercommission/components/table/ajax';
            ...
            case 'search':
                $template = 'pages/usercommission/components/table/table';
            ...
            default:
                $template = 'pages/usercommission/tabswrapper';
            ...
            $html = view($template, compact('usercommission'))->render();
            ...
            return view('pages/usercommission/wrapper', compact('page','usercommission'))->render();
        }
