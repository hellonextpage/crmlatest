...
namespace App\Http\Responses\AppointmentMode;
...
class IndexResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            case 'load':
                $template = 'pages/appointmentmode/components/table/ajax';
            ...
            case 'search':
                $template = 'pages/appointmentmode/components/table/table';
            ...
            default:
                $template = 'pages/appointmentmode/tabswrapper';
            ...
            $html = view($template, compact('appointmentmode'))->render();
            ...
            return view('pages/appointmentmode/wrapper', compact('page','appointmentmode'))->render();
        }
