        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                <select class="form-control form-control-sm"  id="status" name="status">
                    ...
                    <option value="1" @if(isset($appointmenttype) && $appointmenttype->status==1) selected @endif>Active</option>
                    <option value="0" @if(isset($appointmenttype) && $appointmenttype->status==0) selected @endif>Inactive</option>
                </select>
            </div>
        </div>
        <!--/#[edit] city-->
