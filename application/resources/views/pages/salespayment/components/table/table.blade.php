                ...
                <thead>
                    <tr>
                        <th class="team_col_first_name"><a class="js-ajax-ux-request js-list-sorting"
                                ...
                                data-url="{{ urlResource('/team?action=sort&orderby=first_name&sortorder=asc') }}">{{ cleanLang(__('lang.payment_schedled_on')) }}<span
                                    class="sorting-icons"><i class="ti-arrows-vertical"></i></span></a></th>
                        <th class="team_col_position"><a class="js-ajax-ux-request js-list-sorting" id="sort_position"
                                href="javascript:void(0)"
                                data-url="{{ urlResource('/team?action=sort&orderby=position&sortorder=asc') }}">{{ cleanLang(__('lang.payment_due_date')) }}<span
                        ...
                        <th class="team_col_role"><a class="js-ajax-ux-request js-list-sorting" id="sort_role_id"
                                href="javascript:void(0)"
                                data-url="{{ urlResource('/team?action=sort&orderby=role_id&sortorder=asc') }}">{{ cleanLang(__('lang.pay_schedl_sub_total')) }}<span
                                    class="sorting-icons"><i class="ti-arrows-vertical"></i></span>
                        </th>
                        <th class="team_col_email"><a class="js-ajax-ux-request js-list-sorting" id="sort_email"
                                href="javascript:void(0)"
                                data-url="{{ urlResource('/team?action=sort&orderby=email&sortorder=asc') }}">{{ cleanLang(__('lang.pay_schedl_tax')) }}<span
                                    class="sorting-icons"><i class="ti-arrows-vertical"></i></span>
                        </th>
                        <th class="team_col_phone"><a class="js-ajax-ux-request js-list-sorting" id="sort_phone"
                                href="javascript:void(0)"
                                data-url="{{ urlResource('/team?action=sort&orderby=phone&sortorder=asc') }}">{{ cleanLang(__('lang.pay_schedl_grand_total')) }}<span
                                    class="sorting-icons"><i class="ti-arrows-vertical"></i></span>
                        </th>
                        <th class="team_col_last_active"><a class="js-ajax-ux-request js-list-sorting"
                                id="sort_last_seen" href="javascript:void(0)"
                                data-url="{{ urlResource('/team?action=sort&orderby=last_seen&sortorder=asc') }}">{{ cleanLang(__('lang.aptmnt_id')) }}<span
