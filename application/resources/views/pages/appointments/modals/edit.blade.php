...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label required">{{ cleanLang(__('lang.aptmnt_on')) }}*</label>
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm pickadate" id="aptmnt_on" name="aptmnt_on"
                    value="{{ $appointments->aptmnt_on  ?? '' }}">
            </div>
        </div>
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label required">{{ cleanLang(__('lang.cmnts_after_aptmnt')) }}*</label>
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="cmnts_after_aptmnt" name="cmnts_after_aptmnt"
                    value="{{ $appointments->cmnts_after_aptmnt  ?? '' }}">
            </div>
        </div>
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label">{{ cleanLang(__('lang.aptmnt_positivity_rate')) }}</label>
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="aptmnt_positivity_rate" name="aptmnt_positivity_rate"
                    value="{{ $appointments->aptmnt_positivity_rate  ?? '' }}">
            </div>
        </div>
        <!--/#[edit] city-->
